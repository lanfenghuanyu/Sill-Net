...
def get_model(name, class_train, class_test, feature_channel):
    ...
    if name is 'sillnet':
        model = model(nc=3, input_size = 64, class_train=class_train, class_test = class_test, extract_chn=[100, 150, 250, 150, 100, feature_channel], classify_chn = [100, 150, 200, 150, 100, 100, 100], param1 = None, param2 = None, param3 = None, param4 = [150,150,150,150])
